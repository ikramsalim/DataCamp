"""
Get the mean weekly_sales by type using .pivot_table() and
...
mean_med_sales_by_type = sales.pivot_table(values=
...
"""
Get the mean of weekly_sales by type and is_holiday using .pivot_table() and 
